...
/*
/* Old codw from previous implementation of translations
...
Template.supporters.daysUntilFinish = function () {
    ...
    var dString = "November, 30, 2013";
    
    var d1 = new Date(dString);
    var d2 = new Date();
    
    var minutes = "November, 30, 2013: " + DateDiff.inMinutes(d1, d2);
    var hours   = "November, 30, 2013: " + DateDiff.inHours(d1, d2);
    var days    = "November, 30, 2013: " + DateDiff.inDays(d1, d2);
    var weeks   = "November, 30, 2013: " + DateDiff.inWeeks(d1, d2);
...
Template.progress.pledgeProgressPercent = function () {
    ...
    var pctraised   = Math.round(pledgeCount * (2000 / 17000 * 100));
...
Template.progress.pledgeProgressEuros = function () {
    ...
    var pledgeCount = Meteor.users.find({"profile.has_pledged": true}).count();
    var eurosRaised  = pledgeCount * 2000;
...
Template.supporters.listHavePledged = function() {
  ...
  Meteor.subscribe("list-all-users-who-have-pledged");
  var sup = Meteor.users.find({"profile.has_pledged": true}, {fields: {name: 1, 'profile.has_pledged': 1, 'profile.picture': 1, 'profile.message': 1,'profile.name': 1}}).fetch();
